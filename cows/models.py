...
class Cow(models.Model):
    ...
    herd = models.ForeignKey(Herd, on_delete=models.SET_NULL, null=True, blank=True, related_name='cows', verbose_name="Stado")
    ...
    # --- Rodowód ---
    dam = models.ForeignKey('self', on_delete=models.SET_NULL, null=True, blank=True, related_name='offspring_dam', verbose_name="NR MATKI")
    sire = models.ForeignKey('self', on_delete=models.SET_NULL, null=True, blank=True, related_name='offspring_sire', verbose_name="NR OJCA")
